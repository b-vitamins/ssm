...
### Changed
- Replaced the CUDA fused layer norm implementation with a block-reduced kernel
  covering prenorm/postnorm residual fusion, RMSNorm, and bias handling, and
  added CUDA tests for the mixed-precision paths.
